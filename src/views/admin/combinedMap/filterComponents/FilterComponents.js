    ...
    <div>
      <Formik
        ...
        validate={(values) => {
          ...
          if (values.checkedGovernorate.length <= 0) {
            errors.checkedGovernorate = "* مطلوب";
          }
                ...
                <Form
                  ...
                  <FormGroup>
                    <CheckListComponent
                      ...
                      values={values}
                      dataArray={status}
                      listIsOpen={statusListIsOpen}
                      setListIsOpen={setStatusListIsOpen}
                      listTitle="حدد حالة الطلب"
                      selectAll={values.selectAllStatus}
                      fieldValue="selectAllStatus"
                      fieldName="checkedStatus"
                    />
                    <ErrorMessage
                      name="checkedStatus"
                      component={ErrorFormikComponent}
